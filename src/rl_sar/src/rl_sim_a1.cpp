#include "rl_sim_a1.hpp"

// #define PLOT
// #define CSV_LOGGER
// #define ROS_LOGGER // Publish joint target position data (generated by the policy) to ROS topics
...
RL_Sim::RL_Sim()
{
    ...
    std::cout << LOGGER::INFO << "RL_Sim_A1 Started Successfully!!!" << std::endl;
}
